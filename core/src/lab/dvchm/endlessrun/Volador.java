...
public class Volador extends PersonajeAnimado{
	
	
	Personaje jugador;
	Volador(Personaje jugador)
	{
		super(loadImages());
		this.setY(400);
		setX(750);
	...
	public void act(float delta) {
		...
		if(Gdx.input.isKeyPressed(Keys.ESCAPE)||Gdx.input.isKeyPressed(Keys.P) ||Gdx.input.isKeyPressed(Keys.R) || Gdx.input.isKeyPressed(Keys.NUM_1)){
			cont = 0;
			this.setX(800);
			this.setY(400);
			dib_act = 0;
		...
		else if (Gdx.input.isKeyPressed(Keys.NUM_2) || Gdx.input.isKeyPressed(Keys.NUM_3)||Gdx.input.isKeyPressed(Keys.Q)){
